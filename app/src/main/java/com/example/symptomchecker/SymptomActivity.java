...
public class SymptomActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private void insertSymptom() {
        ...
        values.put(SymptomEntry.COLUMN_SYMPTOM_NAME, "Бледность кожи");
        values.put(SymptomEntry.COLUMN_SYMPTOM_DESCRIPTION, "Бледность кожи — осветление кожных покровов, " +
                "связанное с изменением тонуса " +
                "поверхностных сосудов или снижением количества гемоглобина в крови");

        values.put(SymptomEntry.COLUMN_SYMPTOM_NEEDHELP, "В большинстве случаев при бледности кожных покровов нет необходимости в оказании экстренной помощи.\n" +
                "\n" +
                "Немедленно медицинская помощь должна быть оказана в случаях, если бледность кожи возникла внезапно и сопровождается жгучими или давящими болями" +
                " за грудиной, сильными болями в животе, обмороком или внезапной головной болью");

        values.put(SymptomEntry.COLUMN_SYMPTOM_CLASIFICATION, "По месту распространения:\n" +
                "\n" +
                "локальная (отдельных участков);\n" +
                "распространенная.\n" +
                "По времени возникновения:\n" +
                "\n" +
                "острая (внезапно возникшая);\n" +
                "хроническая (постепенно нарастающая и длительно сохраняющаяся).\n");

        values.put(SymptomEntry.COLUMN_SYMPTOM_ISRECOMMENDED, "Больше времени проводить на свежем воздухе.\n" +
                "Избегать нахождения в душных помещениях.\n" +
                "Придерживаться сбалансированного питания.\n" +
                "Проконсультироваться у врача-терапевта.");

        values.put(SymptomEntry.COLUMN_SYMPTOM_ISNOTRECOMMENDED, "Пребывать в длительном состоянии стресса.\n" +
                "Находиться в душных помещениях.");

        values.put(SymptomEntry.COLUMN_SYMPTOM_REASONS, "•\tАнемия.\n" +
